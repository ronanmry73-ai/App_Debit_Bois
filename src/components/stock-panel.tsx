          ...
          <table className="w-full table-fixed text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/60 text-left text-muted-foreground">
                ...
                <th className="w-24 px-2 py-2.5 font-medium">Famille</th>
                <th className="w-32 px-2 py-2.5 font-medium">Dimensions</th>
                <th className="w-32 px-2 py-2.5 font-medium">Type</th>
