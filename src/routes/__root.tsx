  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Calculez le nombre de panneaux 2500×400 et 2500×600 à acheter à partir d’un débit de pièces, avec plan de découpe et taux de chute.",
      },
